...
# rust/.github/workflows/dogfood.yml.jinja is a Copier template, so yamlfmt
# can't format-check it directly. Render both of its `uses_git` variants to
# real workflow files and check those instead.
